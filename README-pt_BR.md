...
Baseado no [Vulcano Framework](http://github.com/wpbrasil/odin).

## Instalação ##

Envie a pasta "vulcano" para a pasta de temas padrão do WordPress `wp-content/themes` ou simplesmente envie o arquivo zipado utilizando o instalador de temas do WordPress.
...
Vulcano suporta nativamente os plugins:
