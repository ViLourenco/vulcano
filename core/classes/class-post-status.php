...
class Vulcano_Post_Status {
	...
	public function meta_tags() {
		...
		printf( '<meta class="vulcano-custom-status-meta" value="%s" />', esc_attr( json_encode( $args ) ) );
	}
	...
	public function scripts() {
		// Load admin JS
		wp_enqueue_script( 'vulcano-custom-status', get_template_directory_uri() . '/core/assets/js/admin-custom-status.js', array( 'jquery' ), null, true );
