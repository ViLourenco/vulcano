...
class Vulcano_Shortcodes {
	...
	function tabs( $atts, $content = null ) {
		return '<ul class="nav nav-tabs vulcano-tabs">' . str_replace( '<br />', '', do_shortcode( $content ) ) . '</ul>';
	}
	...
	function accordions( $atts, $content = null ) {
		extract( shortcode_atts( array(
			'id' => 'vulcano-accordion',
		), $atts ) );

		$html = '<div class="panel-group vulcano-accordion" id="' . $id . '">';
		$html .= str_replace( '<br />', '', do_shortcode( $content ) );
		$html .= '</div>';
	...
	function tooltip( $atts, $content = null ) {
		...
		$html = '<a class="vulcano-tooltip" data-original-title="' . $title . '" href="' . $link .'" data-placement="' . $direction . '" data-toggle="tooltip">';
		$html .= do_shortcode( $content );
		$html .= '</a>';
	...
	function map( $atts, $content = null ) {
		...
		$html = '<div class="vulcano-map" id="' . $id . '" style="width: ' . $width . 'px; height: ' . $height . 'px;"></div>';

		$js = '<script type="text/javascript" src="//maps.google.com/maps/api/js?sensor=false"></script>';
		$html .= apply_filters( 'vulcano_map_shortcode_js_' . $id, $js );
