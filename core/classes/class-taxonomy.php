...
class Odin_Taxonomy {
	...
	protected function labels() {
		$default = array(
			...
			'add_or_remove_items'        => sprintf( __( 'Add or Remove %ss', 'vulcano' ), $this->name ),
			...
			'parent_item'                => sprintf( __( 'Parent %s:', 'vulcano' ), $this->name ),
			...
			'new_item_name'              => sprintf( __( 'New %s', 'vulcano' ), $this->name ),
			'all_items'                  => sprintf( __( 'All %ss', 'vulcano' ), $this->name ),
			'separate_items_with_commas' => sprintf( __( 'Separate %ss with comma', 'vulcano' ), $this->name ),
			'choose_from_most_used'      => sprintf( __( 'Choose from %ss most used', 'vulcano' ), $this->name )
		);
