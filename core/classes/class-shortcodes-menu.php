...
class Vulcano_Shortcodes_Menu {
     ...
     *
     * @return array          Vulcano TinyMCE plugin.
     */
    public function add_shortcode_tinymce_plugin( $plugins ) {
        $plugins[ 'vulcano_shortcodes' ] = get_template_directory_uri() . "/core/assets/js/editor-shortcodes.js";
    ...
    public function add_tinymce_locales( $locales ) {
        $locales[ 'vulcano_shortcodes' ] = plugin_dir_path( __FILE__ ) . '/../../inc/vulcano-shortcodes-editor-i18n.php';

        return $locales;
    }
}

new Vulcano_Shortcodes_Menu;
