...
* Created a new `vulcano_thumbnail()` function with `Odin_Thumbnail_Resizer` class.
...
* Added $name in `vulcano_save_metabox_*` filter in `Odin_Metabox` class.
* Addded `vulcano_front_end_form_redirect_*` in `Odin_Front_End_Form` class.
* Added `separator` field type in `Odin_Metabox` class.
* Added `vulcano_metabox_container_before_*` filter in `Odin_Metabox` class.
* Added `vulcano_metabox_wrap_before_*` filter in `Odin_Metabox` class.
* Added `vulcano_metabox_field_title_*` filter in `Odin_Metabox` class.
* Added `vulcano_metabox_field_before_*` filter in `Odin_Metabox` class.
* Added `vulcano_metabox_field_after_*` filter in `Odin_Metabox` class.
* Added `vulcano_metabox_wrap_after_*` filter in `Odin_Metabox` class.
* Added `vulcano_metabox_container_after_*` filter in `Odin_Metabox` class.
